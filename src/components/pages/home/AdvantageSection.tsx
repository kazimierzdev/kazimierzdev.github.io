...
const AdvantageSection = () => {
  ...
  const advantages = [
    ...
    {
      title: t('your_advantages.standardized_individualization'),
      description: t('your_advantages.standardized_individualization_description'),
    },
    {
      title: t('your_advantages.scalable_marketing'),
      description: t('your_advantages.scalable_marketing_description'),
    },
  ];
