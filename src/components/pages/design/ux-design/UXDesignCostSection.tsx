    ...
    <section className="py-28">
      <div className="container mx-auto px-8 md:px-0">
        <div className="flex flex-col md:flex-row items-center gap-28">
          ...
          <div className="flex-1">
            <h4 className="text-black text-4xl font-bold mb-8">{t('ux_design.practical_design')}</h4>
            <p className="text-lg mt-4 mb-12">{t('ux_design.practical_design_description')}</p>
