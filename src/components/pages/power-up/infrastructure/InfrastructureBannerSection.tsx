      ...
      <div className="relative flex w-full h-full items-center justify-center">
        <div className="container mx-auto px-8 md:px-0 flex flex-col md:flex-row md:items-end xl:pt-[100px] xl:pb-32">
          <div className="lg:w-5/12">
            <h1 className="relative text-4xl md:text-7xl lg:text-9xl text-white font-bold md:w-1/2 lg:w-2/3 leading-tight md:pl-12 pb-12 md:pb-0">
...
export default InfrastructureBannerSection;
