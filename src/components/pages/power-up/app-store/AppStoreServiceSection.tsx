      ...
      <div className="container mx-auto px-8 md:px-0">
        <div className="flex flex-col md:flex-row md:items-center gap-28">
          <div className="flex-1">
            <h4 className="text-white text-4xl font-bold mb-8">{t('apps.analytics_service')}</h4>
            <p className="text-lg mt-4 mb-12 text-white">{t('apps.analytics_service_description')}</p>
            <button className="btn bg-secondary px-20 py-4 font-bold text-white rounded uppercase">
              {t('apps.inquire_for_free')}
            </button>
          </div>
          <div className="flex-1">
