      ...
      <div className="relative flex w-full h-full items-center justify-center">
        <div className="container mx-auto px-8 md:px-0 flex flex-col md:flex-row md:items-end xl:pt-[100px] xl:pb-32">
          <div className="lg:w-5/12">
            <h1 className="relative text-4xl md:text-7xl lg:text-9xl text-white font-bold md:w-1/2 lg:w-full leading-tight md:pl-12 pb-12 md:pb-0">
              ...
              <span className="block relative z-10 leading-snug">Our</span>
              <span className="block relative z-10 leading-snug">Services</span>
              <span className="block relative z-10 leading-snug text-transparent text-stroke">for her</span>
            </h1>
          </div>
          <div className="lg:w-7/12">
            <h5 className="text-white text-4xl md:ml-24 mb-16 md:mb-0">Building a great software product takes more than just the right technologies.</h5>
          </div>
        </div>
      </div>
    </section>
